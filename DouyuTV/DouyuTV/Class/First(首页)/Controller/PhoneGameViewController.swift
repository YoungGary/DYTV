...
private let phonecellID = "phonegame"

private let kTopicViewH : CGFloat = 200

class PhoneGameViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate{
    ...
    lazy var collectionView : UICollectionView = {[unowned self] in
        ...
        collectionView.register(UINib(nibName: "VideoCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: phonecellID)
    ...
    var viewModel : PhoneGameViewModel = PhoneGameViewModel()
...
extension PhoneGameViewController{
    func setupInterface() -> () {
...
extension PhoneGameViewController{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: phonecellID, for: indexPath) as! VideoCollectionViewCell
